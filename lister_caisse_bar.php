...
<table border="0" class="page" align="center">
	<tr>
		<td class="page" align="center">
		    	<h3>Liste des différents enregistrements de caisse journalière du<FONT size="5em" color="#009EDF"> bar</FONT></h3>
			<?php if ($user_admin != 'n'){?>
			<SCRIPT LANGUAGE="JavaScript">
				...
				<?php } ?>
			 <hr>
			La caisse "bar" est actuellement de <FONT face="Comic Sans MS" color="#009edf"><?php echo "$total_caisse $devise"; ?></FONT>
			Avec <hr>
			<?php
		...
		<td>
			<table class="boiteaction">
				...
				<tr class="texte1" onmouseover="this.className='highlight'" onmouseout="this.className='texte1'">
					...
					<td class="highlight"><b><FONT color="white"><?php echo "$total"; ?><?php echo "$devise";?></font></b></td>
					<td class="highlight"><?php echo "$user"; ?></td>
					<td class="highlight" colspan="3">&nbsp;</td>
					<td class="highlight"><a href='form_edit_caisse.php?id_enregistrement_caisse=<?php echo $id_enregistrement_caisse; ?>' title="<?php echo $lang_editer; ?>"><img border=0 alt="<?php echo $lang_editer; ?>" src="image/edit.png"></a></td>
					<td class="highlight"><a href="delete_caisse.php?id_enregistrement_caisse=<?php echo $id_enregistrement_caisse; ?>" onClick="return confirmDelete('voulez-vous vraiment effacer cet enregistrement?')" title="<?php echo $lang_suprimer; ?>"><img border=0 alt="<?php echo $lang_suprimer; ?>" src="image/delete.png" ></a></td>
				</tr>
						<?php
