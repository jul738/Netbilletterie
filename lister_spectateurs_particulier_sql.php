									   ...
									   <SELECT NAME='id_tarif'>
											...
											while ( $row = mysql_fetch_array( $result3)) {
													...
													$prix_tarif2 = $row["prix_tarif"];."
                                                                                        <OPTION VALUE='".$id_tarif2."' ". if($id_tarif==$id_tarif2){echo 'selected';}".>." echo "$nom_tarif2 $prix_tarif2 $devise ";."</OPTION>
											".}."
										...
										<OPTION VALUE='".$id_tarif."'>".$nom_tarif $prix_tarif $devise."</OPTION>
												}
										</SELECT>",
                                                                                
          'paiement' => ".include('include/paiemment.php');.",
          'enregistrer' => "<input type='hidden' name='num_bon' value='".$bon_num."'>
