...
<table border="0" class="page" align="center">
	...
	<tr>
		<td style="text-align:center;background-color:#E8E8EC;">
  ...
  <center><table  id="datatables"  class="display">	
...
while($data = mysql_fetch_array($req))
    {
  	...
  	$stock="<h1>$stock</h1>";
		...
		<td class="highlight"><a href='edit_art.php?article=<?php echo $num; ?>' title='Editer'>
			<img border=0 alt="<?php echo $lang_editer; ?>" src="image/edit.png" alt='Editer'></a></td>
 ...
 ?>
 <tr><td colspan="10" class="submit" style="background-color:#E8E8EC"></td>
  </table>
  </center>
  <?php
 $aide = article;
