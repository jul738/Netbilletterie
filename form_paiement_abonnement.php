...
$sql = "SELECT mail, login, client_num, num_abo_com, ctrl, fact, attente, coment, tot_tva, nom, num_abonnement,
					...
					<table class="boiteaction">
						...
						<tr>
							...
							<td><SELECT name="banque">
								...
								</SELECT><a href="lister_banque.php">Ajouter une banque e la liste</a>
							</td>
						...
						<tr>
							...
							<input name="num_abo_com" type="hidden" value="<?php echo $num_abo_com ;?>">
