...
<table border="0" class="page" align="center">
	<tr>
		<td class="page" align="center">
		    	<h3>Liste des différents enregistrements de caisse journalière de la<FONT color="#009EDF"> Billetterie</FONT></h3>
			<?php if ($user_admin != 'n'){?>
			<SCRIPT LANGUAGE="JavaScript">
				...
				<?php } ?>
			 <hr>
			La caisse "billetterie" est actuellement de <FONT face="Comic Sans MS" color="#009EDF"><?php echo "$total_caisse $devise"; ?></FONT>
			Avec <hr>
			<?php
		...
		<td>
			<table class="boiteaction">
				...
				<tr class="texte1" onmouseover="this.className='highlight'" onmouseout="this.className='texte1'">
					...
					<td class="highlight"><b><FONT color="black"><?php echo "$total"; ?><?php echo "$devise";?></font></b></td>
