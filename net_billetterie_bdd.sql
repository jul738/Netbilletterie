...
--
-- Client: localhost
-- Généré le: Mar 15 Juillet 2014 à 13:44
...
--
-- Base de données: `net_billetterie_bdd`
--
...
CREATE TABLE IF NOT EXISTS `abonnement_comm` (
  ...
  `choix_spectacle_1` varchar(255) DEFAULT NULL,
  `choix_spectacle_2` varchar(255) DEFAULT NULL,
  `choix_spectacle_3` varchar(255) DEFAULT NULL,
  `choix_spectacle_4` varchar(255) DEFAULT NULL,
  `choix_spectacle_5` varchar(255) DEFAULT NULL,
  `choix_spectacle_6` varchar(255) DEFAULT NULL,
  `choix_spectacle_7` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `abonnement_paiement` (
  ...
  `quantite` int(11) NOT NULL COMMENT 'quantite d abonnement compris dans la commande',
