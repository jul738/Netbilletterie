	...
	<tr>
		<td>
				...
				<tr class="texte<?php echo"$line" ?>" onmouseover="this.className='highlight'" onmouseout="this.className='texte<?php echo"$line" ?>'">
					...
					<td class="highlight"><a href='edit_tarif.php?id_tarif=<?php echo $id_tarif; ?>'><img border=0 alt="<?php echo $lang_editer; ?>" src="image/edit.png"></a></td>
					<td class="highlight"><a href="delete_tarif.php?id_tarif=<?php echo $id_tarif; ?>" onClick="return confirmDelete('<?php echo"$lang_tarif_effa ?"; ?>')"><img border=0 alt="<?php echo $lang_suprimer; ?>" src="image/delete.png" ></a></td>
				</tr>
				<?php
				}
				?>
