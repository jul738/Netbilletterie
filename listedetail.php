...
<table class="page" align="center">
    ...
    <tr>
        <td class="page" align="center">
             <h3>Liste d�taill�e des commandes de billets </h3>
        </td>
    </tr>
    <tr>
        <td>
             <form action="lister_detail_bon.php" method="get">
                <center>
                    <table>
                      <caption>
                      Liste d�taill�e des commandes en choisissant les dates.
                      </caption>
                      <tr>
        ...
        <td>
             <form action="lister_pointes_ok.php" method="get">
                <center>
                    <table>
                      <caption>
                      Liste d�taill�e des commandes point�es "ok" en choisissant les dates
                      </caption>
                      <tr>
                        <td class="texte0">Choisir les dates entre le (aaaa-mm-jj)</td>
                        <td align=left> <input name="date_debut" type="text" size="10" maxlength="40" value="<?php echo $date_today;?>"></td>
...
?>
    ...
    <center>
        <table class="boiteaction">
                    ...
                    <caption> Les commandes d�taill�es de la saison culturelle <?php echo "$annee_2 - $annee_1"; ?></caption> 
