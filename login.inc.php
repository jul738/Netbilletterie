...
<div id=global>
	...
	<div>
		<h1>Net-Billetterie</h1></a><h2>Logiciel de billetterie et de gestion des abonnements</h2>
	</div>
	<div id=image>
		<a href="http://net-billetterie.tuxfamily.org/"><img src="image/logoNetBilletterie.png" alt="NetBilletterie" ></a>
	</div>
	<div id=logo>
		<a href="<?php echo $site;?>"><img src="image/logompt.png"   width="200"></a>
	</div>
	<div id=form>
		<form action="login.inc.php" name="login" method='post' onSubmit="return check();">
			...
			<input name="submit" type="Image" src="image/valider.png" border="0" /> 
		</form>
	</div>
</div>
</body>
