...
$lang_oubli_champ = "Vous avez oublil de renseigner un champ.";
...
$lang_tri = "Trier par";
$lang_date = "Date";
$lang_client_enr = "Votre nouveau spectateur $nom a bien ete enregistre.";
$lang_effacer_bon = "Etes-vous sur de vouloir effacer le billet $num_bon de $nom ?";
$lang_effacer = "Effacer";
$lang_client = "spectateur";
$lang_rech = "Rechercher";
$lang_client_ajouter = "Ajouter un spectateur";
$lang_bon_effa = "Le billet $num_bon a ete efface.";
$lang_li_effa = "La ligne a ete effacee.";
