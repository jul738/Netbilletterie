...
$lang_choix_theme ="Choisir le thème de Net-Billetterie";
...
$lang_conf_env = " Êtes-vous sur de vouloir enregister la facture n°";
$lang_conf_env2= "par mail au spectateur";
$lang_conf_notif =" Êtes-vous sur de vouloir notifier le spectateur";
$lang_conf_notif2 ="de l\'existence de la facture ";
$lang_par ="par";
$lang_conf_carte_reg =" Êtes-vous sur de vouloir régler la facture n° ";
$lang_con_env_pdf=" Êtes-vous sur de vouloir envoyer par mail le billet n°";
$lang_con_env_notif=" Êtes-vous sur de vouloir notifier par mail le spectateur du billet n°";
...
$lang_cre_fac_orph ="Créer une facture a partir du billet n°";
...
$lang_regler_fact2 ="au statut reglé ?";
///Variables modifi�es
...
$lang_regler_fact = " Êtes-vous sur de vouloir mettre la facture n° ";
$lang_art_effa= " Êtes-vous sur de vouloir effacer le spectacle ";
$lang_lot_inact= " Êtes-vous sur de vouloir désactiver le lot n° ";
$lang_cli_effa = " Êtes-vous sur de vouloir effacer le spectateur ";
$lang_eff_dev = " Êtes-vous sur de vouloir effacer le devis n°";
$lang_convert_dev = " Êtes-vous sur de vouloir transformer le devis n°";
$lang_convert_dev2 = "en reservation?";
$lang_dev_perd = " Êtes-vous sur de vouloir mettre le devis n°";
$lang_dev_perd2 ="au statut perdu ?";
$lang_eff_conf_dep = "Êtes-vous sur de vouloir effacer la dépense n°";
////

////
$lang_fi_b_c="billet";
$lang_facture="Facture";
$lang_fact_mu_err = "Aucune facture n'a été créée le ";
...
$lang_po_acquis = "Pour acquis";
$lang_nouv_d="Nouvelle facture de ";
$lang_nouv_add ="Une nouvelle facture vous a été adressée par";
...
$lang_impo_del_util = "impossible d'effacer cet utilisateur . Vous devez d'abord lui retirer les droits d'administration";
$lang_con_effa_utils = "Êtes-vous sûr de vouloir effacer cet utilisateur ?";
...
$lang_choi_cli_enr = "vous devez à présent choisir les spectateurs qu\'il pourra gérer";
$lang_don_rest = "vous avez donné des droits restreints à l'utilisateur"; 
$lang_est_enr = "est maintenant enregistré et a comme login:";
$lang_ret_cli_util = "Retirer un spectateur à cet utilisateur";
...
$lang_ger_cli ="Peut gérer les spectateurs ?";
$lang_ger_art = "Peut gérer les spectacles ?";
$lang_ger_stat = "Peut gérer les statistiques ?";
$lang_ger_dep = "Peut gérer les depenses ?";
$lang_ger_fact = "Peut gérer les factures ?";
$lang_ger_com = "Peut gérer les réservations ?";
$lang_ger_dev = "Peut gérer les devis ?";
$lang_val_actu = "Valeur Actuelle";
$lang_util_droit = "Les droits de cet utilisateur";
$lang_utilisateur_editer = "Éditer un utilisateur";
$lang_retirer = "Retirer";
$lang_multi_ctrl = "Vous pouvez choisir plusieurs spectateurs en enfoncant la touche 'Ctrl' de votre clavier";
$lang_ajou_cli_util = "Ajouter un spectateur pour cet utilisateur";
$lang_oui = "oui";
$lang_non = "non";
...
$lang_bon_editer = "Modifier la réservation";
...
$lang_devis_creer = "Creer un ".$lang_devis."";
