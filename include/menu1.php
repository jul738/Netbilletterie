...
Modification : Jos� Das Neves pitu69@hotmail.-->
...
<div id="header">
	...
	<div id="logo">
		<!--Menu 1er niveau-->
		<a href="accueil.php" rel="menu0"><img border ="0" src="image/logompt_transparent.png" alt=""></a>
	</div>
	...
	<div class="menublock" >
		<!--Menu 1er niveau-->
			...
			<ul id="solidmenu" class="solidblockmenu">
				...
				<li><a href="accueil.php" rel="menu11" id="accueil"><img border ="0" src="" alt="Accueil"><br></a></li>
				<li><a href="form_client.php" rel="menu1" id="spectateurs"><img border ="0" src="" alt="Spectateur"><br><?php // echo $lang_clients; //?></a></li>
				<li><a href="form_commande.php" rel="menu2" id="reservations"><img border ="0" src="" alt="Réservation"><br></a></li>
		...
		<div id="menu5" class="mega solidblocktheme">
			...
			<div class="column">
				<ul>
					...
					<li><a href="impression_caisse.php"><b><img src="image/print_mini.png"><br>&nbsp;Imprimer les opérations de caisse</b></a></li><hr/>
				</ul>
			</div>
			</div>
		...
		<div id="menu9" class="mega">
			...
			<div class="column">
				<ul>
					...
					<li><a href="lister_tarif.php"><img border ="0" src="image/tarif.png" alt="Tarifs"><br>&nbsp;Tarifs</a></li><hr/>
