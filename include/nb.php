...
Les nombres peuvent �tre entier, a virgule, mais positif, et ecrit uniquement en chiffres et virgule.
****/
$devise= '€';
...
//		if ($rc != "z&eacute;ro"){ 
		...
		// Si on utilise des devis, on affiche "z�ro" et non "z�ro z�ro" apr�s la virgule
		// ... attention: �a ne marche que s'il y a maximum 2 d�cimales.
